...
-->
                    ...
                    <li><a href="http://localhost/prj/orderlist.php">Order List</a></li>
<!--                    <li><a href="http://localhost/prj/log_form.php">Login</a></li>-->
<!--                    <li><a href="http://localhost/prj/reg_form.php">SignUp</a></li>-->
                    <li><a href="http://localhost/prj/showdata.php">Show Item</a></li>
                    <li><a href="http://localhost/prj/insert.php">Insert Food</a></li>
