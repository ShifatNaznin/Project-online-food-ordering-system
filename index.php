...
-->
                    ...
                    <li><a href="http://localhost/prj/log_form.php">User Login</a></li>
                    <li><a href="http://localhost/prj/reg_form.php">SignUp</a></li>
                    <li><a href="http://localhost/prj/log_admin.php">Admin Login</a></li>
                    
<!--                    <li><a href="http://localhost/prj/showdata.php">Show Cart</a></li>-->
